...
class Matchmaking_Test(TestCase):
	...
	def test_scoring(self):
		...
		resp=self.client.post('/',{'refugee_or_local': 'R', 'first_name': 'Sara', 'last_name': 'Akhbar', 'location':'Rapperswil', 'occupation':'Architect', 'about':'guitar, tennis', 'email':'p.jayatthissa@gmail.com', 'gender':'M', 'gender_preference':'A', 'language_1':'es', 'language_2':'es', 'language_3':'es', 'birthdate':'1982-09-27', 'social_media':'http://www.example.com' })
