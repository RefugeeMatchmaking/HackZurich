...
class UserForm(forms.ModelForm):
	...
	class Meta:
		...
		fields = ['refugee_or_local', 'first_name', 'last_name', 'location', 'occupation', 'about', 'email', 'gender', 'gender_preference', 'language_1','language_2','language_3','birthdate', 'social_media']
