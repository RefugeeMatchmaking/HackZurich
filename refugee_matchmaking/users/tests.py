...
class Matchmaking_Test(TestCase):
	...
	def test_scoring(self):
		...
		self.client.post('/',{'refugee_or_local': 'R', 'first_name': 'Ali', 'last_name': 'aladin', 'location':'Zurich', 'occupation':'Architect', 'about':'violin, tennis', 'email':'p.jayatthissa@gmail.com', 'gender':'M', 'gender_preference':'A', 'birthdate':'1985-09-27', 'social_media':'http://www.example.com' })
